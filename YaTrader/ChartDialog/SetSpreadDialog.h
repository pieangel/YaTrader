...
class SetSpreadDialog : public CBCGPDialog
{
	DECLARE_DYNAMIC(SetSpreadDialog)

public:
	SetSpreadDialog(CWnd* pParent = nullptr);   // standard constructor
	SetSpreadDialog(RealTimeMultiChart* parent);
	virtual ~SetSpreadDialog();

// Dialog Data
#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_ABROAD_SET };
#endif
