...
class SmTrendChart : public CBCGPDialog
{
	DECLARE_DYNAMIC(SmTrendChart)

public:
	SmTrendChart(CWnd* pParent = nullptr);   // 표준 생성자입니다.
	virtual ~SmTrendChart();
...
private:
	...
	DarkHorse::SmChartStyle _MainChartType = DarkHorse::SmChartStyle::MultiColor;
	int _MainDataType = 0;
	...
	std::shared_ptr<DarkHorse::SmChartData> _ChartData;
