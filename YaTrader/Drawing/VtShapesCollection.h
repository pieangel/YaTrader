...
public:
	...
	static void SanitizeRect(VtPoint& start, VtPoint& end);
	...
	void DrawObjects(DoubleArray& timeStamp, XYChart* chart);
	...
	void AddLine(SmPoint start, SmPoint end, VtColor penColor, int penWidth);
	void AddRect(SmPoint start, SmPoint end, VtColor penC, int penWidth, VtColor fillC, bool filled);
	void AddEllipse(SmPoint start, SmPoint end, VtColor penC, int penWidth, VtColor fillC, bool filled);
private:
