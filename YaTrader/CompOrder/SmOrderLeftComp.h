...
class SmOrderLeftComp : public CBCGPDialog
{
	DECLARE_DYNAMIC(SmOrderLeftComp)

public:
	SmOrderLeftComp(CWnd* pParent = nullptr);   // standard constructor
	virtual ~SmOrderLeftComp();
...
public:
	void SetMainWnd(SmOrderCompMainDialog* main_wnd);
